...
/**
 * The when-fields a chore edit saves to the chore itself: how often it repeats
 * and the due date it is anchored to. (Its "show from" is a per-phone setting,
 * kept apart in ChoreLeadStore.)
 */
